...
static std::unique_ptr< QgsMultiCurve > parseEsriGeometryPolyline( const QVariantMap &geometryData, QgsWkbTypes::Type pointType )
{
  ...
  for ( const QVariant &pathData : pathsList )
  {
...
QVariantMap QgsArcGisRestUtils::getObjectIds( const QString &layerurl, const QString &objectIdFieldName, QString &errorTitle, QString &errorText, const QgsRectangle &bbox )
{
  ...
  QUrlQuery query;
  query.addQueryItem( QStringLiteral( "f" ), QStringLiteral( "json" ) );
  query.addQueryItem( QStringLiteral( "where" ), QStringLiteral( "%1=%1" ).arg( objectIdFieldName ) );
    ...
    QString &errorTitle, QString &errorText, QgsFeedback *feedback )
{
  ...
  {
    query.addQueryItem( QStringLiteral( "returnGeometry" ), QStringLiteral( "false" ) );
    query.addQueryItem( QStringLiteral( "outFields" ), outFields );
  }
  query.addQueryItem( QStringLiteral( "returnM" ), fetchM ? "true" : "false" );
  query.addQueryItem( QStringLiteral( "returnZ" ), fetchZ ? "true" : "false" );
...
QList<quint32> QgsArcGisRestUtils::getObjectIdsByExtent( const QString &layerurl, const QString &objectIdField, const QgsRectangle &filterRect, QString &errorTitle, QString &errorText, QgsFeedback *feedback )
{
  ...
  QUrlQuery query;
  query.addQueryItem( QStringLiteral( "f" ), QStringLiteral( "json" ) );
  query.addQueryItem( QStringLiteral( "where" ), QStringLiteral( "%1=%1" ).arg( objectIdField ) );
  query.addQueryItem( QStringLiteral( "returnIdsOnly" ), QStringLiteral( "true" ) );
  query.addQueryItem( QStringLiteral( "geometry" ), QStringLiteral( "%1,%2,%3,%4" )
                         .arg( filterRect.xMinimum(), 0, 'f', -1 ).arg( filterRect.yMinimum(), 0, 'f', -1 )
                         .arg( filterRect.xMaximum(), 0, 'f', -1 ).arg( filterRect.yMaximum(), 0, 'f', -1 ) );
  ...
  QList<quint32> ids;
  for ( const QVariant &objectId : objectIdData["objectIds"].toList() )
  {
    ids << objectId.toInt();
  }
  return ids;
